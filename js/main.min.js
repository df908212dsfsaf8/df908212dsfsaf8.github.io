! function (e) {
	...
	! function (e) {
		...
		function a() {
			return t() ? {
				type: "locale",
				value: (e = void 0 !== navigator.languages ? navigator.languages[0] : navigator.language, '"' === e[0] && (e = e.substr(1)), e.length > 0 && '"' === e[e.length - 1] && (e = e.substr(0, e.length - 1)), (e && 5 === e.length && "-" === e[2] ? e.substr(0, 3) + e.substr(3).toLocaleUpperCase() : e) || "<none>")
			} : {
				type: "locale",
			...
			h = function () {
				...
				return e.prototype.track = function (e) {
					...
					if (this.trackPageData) {
						...
						if (h && h !== t && (d.transitions = c(h, t), !l)) {
							var p = Date.now();
							this.trackPageData.time = p, d.duration = u(p - s, h + " - ")
						}
					...
					if (e && "function" == typeof navigator.sendBeacon && !this.options.disabled && this.trackPageData) {
						var t = this.trackPageData,
							...
							a = t.path,
							o = {};
						o.duration = u(Date.now() - e, a + " - ");
						var i = document.activeElement && document.activeElement.href || "",
							s = n();
						i ? "/" !== i[0] && i.substr(0, s.length) !== n() && (o.transitions = c(a, i)) : o.bounces = r ? "Yes" : "No", navigator.sendBeacon = navigator.sendBeacon || function (e, t) {
			...
			if (e.length > 0) {
				var t = new IntersectionObserver(function (e, t) {
					e.forEach(function (e) {
						var n, r;
						e.isIntersecting && (r = (n = e.target).dataset.lazy, n.src = r, n.classList.add("loaded"), t.unobserve(e.target))
					})
				}, {
					threshold: .5
				});
